 ...
 * on 2020/1/7 0007
 */
public class Tab2ExchangeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private LuRecyclerViewAdapter mLuRecyclerViewAdapter = null;
    private PreviewHandler mHandler = new PreviewHandler();
    private Tab2ExchangeAdapter mDataAdapter;
    private int page = 1;
    ...
    protected void initData() {
        ...
        mDataAdapter = new Tab2ExchangeAdapter(getActivity());
