...
public class RefundDetialAdapter extends RecyclerView.Adapter<RefundDetialAdapter.MyViewHolder> {

    private Context mContext;
    private List<OrderDetailBean.DataBean.GoodsBean> dataBean;

    public RefundDetialAdapter(Context mContext, List<OrderDetailBean.DataBean.GoodsBean> dataBean) {
